...
public class LWDiscoveryService extends AbstractDiscoveryService implements DiscoveryService, ThingHandlerService {
    ...
    public void startBackgroundDiscovery() {
        ...
        try {
            discover();
        } catch (LightwaveCommException | LightwaveLoginException e) {
    ...
    private void discover() throws LightwaveCommException, LightwaveLoginException {
        discoverStructures();
    }


    private void discoverStructures() throws LightwaveCommException {
